// ─────────────────────────────────────────────────────────────────────────────
// ROADMAP CONSTANTS
// Python backend/services/roadmap/constants.py'nin JS karşılığı
// ─────────────────────────────────────────────────────────────────────────────
...
export const DISCIPLINES = {
    ...
    milestones: [
      ...
      },
      {
        ...
        action_steps: [
          ...
          "Uygulamanız için optimize çok katmanlı bir Dockerfile yazın",
  ...
  "Frontend Engineer": {
    ...
    milestones: [
      ...
      },
      {
        ...
        why_needed: "Modern web uygulamaları için JavaScript'in async yapısını ve TypeScript'i kavramanız şarttır.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Büyük ölçekli web uygulamaları geliştirmek için React veya Next.js gibi modern bir framework şarttır.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Hızlı, tutarlı ve premium arayüzler üretmek için Tailwind CSS gibi modern bir framework kullanmalısınız.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Uygulamanızın hızını ve kullanıcı deneyimini optimize etmek için build araçlarını kavramanız gerekir.",
        action_steps: [
  ...
  "DevOps Engineer": {
    ...
    milestones: [
      ...
      },
      {
        ...
        why_needed: "Uygulamalarınızı konteynerize etmek için Kubernetes ve Docker'ı öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Altyapıyı tutarlı ve tekrarlanabilir şekilde yönetmek için IaC araçlarını kullanmalısınız.",
        action_steps: [
          "Terraform HCL ile temel bir cloud kaynağı tanımlayın",
      ...
      },
      {
        ...
        why_needed: "Sistemlerin sağlığını izlemek için Prometheus/Grafana veya ELK Stack gibi araçları kurmalısınız.",
        action_steps: [
  ...
  "Mobile Developer": {
    ...
    color: "#a78bfa",
    lang_weights: {
      Kotlin: 0.95, Swift: 0.95, Dart: 0.9,
    ...
    milestones: [
      {
        ...
        why_needed: "Mobil uygulama geliştirme için Kotlin/Swift dilinin temellerini ve modern UI tasarımını kavramanız gerekir.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Karmaşık mobil uygulamalarda state yönetimi ve navigasyonu doğru mimariyle kurmanız şarttır.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "API entegrasyonu ve yerel veri saklama için ağ kütüphaneleri ve yerel veritabanı çözümlerini entegre etmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Uygulamanızı Google Play veya App Store'a yayınlamak için imzalama ve dağıtım araçlarını öğrenmelisiniz.",
        action_steps: [
  ...
  "Game Developer": {
    ...
    color: "#f59e0b",
    lang_weights: {
      "C#": 0.95, "C++": 0.95, GDScript: 0.98, Lua: 0.9,
    ...
    milestones: [
      {
        ...
        why_needed: "Oyun geliştirmenin temeli olan vektör matematiği ve fizik motorlarını kavramanız gerekmektedir.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Modern oyun geliştirme süreçleri Unity, Unreal veya Godot gibi motorlar üzerinde yürütülür.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Performanslı oyun kodu için Object Pooling, State Machine ve ECS kalıplarını öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Görsel kaliteyi artırmak için shader yazımı ve grafik API'lerini kavramanız gerekmektedir.",
        action_steps: [
  ...
  "AI & ML Engineer": {
    ...
    color: "#c084fc",
    lang_weights: {
      Python: 0.95, R: 0.95, Julia: 0.75, MATLAB: 0.7,
      Scala: 0.65, SQL: 0.5,
    },
    repo_signatures: [
    ...
    milestones: [
      ...
      },
      {
        ...
        why_needed: "Model eğitmeden önce veriyi temizlemek ve analiz etmek için Pandas ve NumPy kütüphanelerini etkin kullanmanız şarttır.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Gerçek problemleri çözmek için temel ML algoritmalarını kodlayıp değerlendirmeyi öğrenmelisiniz.",
        action_steps: [
  ...
  "Cyber Security Specialist": {
    ...
    color: "#ef4444",
    lang_weights: {
      Python: 0.85, C: 0.9, "C++": 0.85, Assembly: 0.95,
      Shell: 0.8, Bash: 0.8, Ruby: 0.5, Go: 0.5,
    },
    repo_signatures: [
    ...
    milestones: [
      {
        ...
        why_needed: "Siber güvenliğin temeli ağ protokollerini derinlemesine kavramaktır.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Güvenlik testleri ve exploit geliştirme için Linux işletim sistemi kavramlarını derinlemesine bilmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Sistemlerdeki güvenlik açıklarını tespit edip raporlamak için sızma testi metodolojisini öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Güvenli iletişim ve veri koruma için kriptografi prensiplerini kavramanız gerekmektedir.",
        action_steps: [
    ...
    milestones: [
      {
        ...
        why_needed: "Blok zinciri teknolojisinin temel prensiplerini kavramadan üzerine uygulama geliştirmek mümkün değildir.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Ethereum ve uyumlu ağlarda merkezi olmayan uygulamalar geliştirmek için Solidity öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Akıllı sözleşmeleri kullanıcıya açmak için Web3 kütüphanelerini ve cüzdan entegrasyonlarını öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "DeFi protokollerini anlamak için AMM, likidite havuzları ve tokenomics kavramlarını kavramanız gerekmektedir.",
        action_steps: [
  ...
  "Embedded & IoT Engineer": {
    ...
    color: "#4ade80",
    lang_weights: {
      C: 0.95, "C++": 0.9, Assembly: 0.95, Rust: 0.85,
    ...
    milestones: [
      {
        ...
        why_needed: "Gömülü sistemlerde bellek ve donanım kaynaklarını yönetmek için C dilini ve low-level programlamayı öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "Sensörler ve harici modüllerle iletişim kurmak için UART, SPI, I2C gibi protokolleri kavramalısınız.",
        action_steps: [
          "Arduino/STM32 ile GPIO kullanarak LED ve buton projesi yapın",
          "I2C protokolü ile bir sensörden veri okuyun",
      ...
      },
      {
        ...
        why_needed: "Gerçek zamanlı sistemler geliştirmek için RTOS kavramlarını ve interrupt yönetimini öğrenmelisiniz.",
        action_steps: [
      ...
      },
      {
        ...
        why_needed: "IoT cihazlarını buluta bağlamak için MQTT, LoRaWAN ve BLE gibi protokolleri öğrenmelisiniz.",
        action_steps: [
...
// Tuple yerine "Primary|Secondary" string key kullanıyoruz
